...
export default function webpage() {
  ...
  const handleInitializeWebContent = async () => {
    ...
    try {
      setIsLoading(true)
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_BASE_URL}/webpage/initialize`, {
        method: 'POST',
        headers: {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_SERVER_BASE_URL}/webpage/chat`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
